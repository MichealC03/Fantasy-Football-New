...
merged_rbs_df = pd.merge(merged_df, sleeperDf, on='Name', how='left')
merged_rbs_df = pd.merge(merged_rbs_df, underDogDf, on='Name', how='left')

merged_rbs_df['Rankings'] = merged_rbs_df.index + 1

merged_rbs_df.rename(columns={
    'Rankings': 'Rk',
    'PosRk_x': 'Sleeper Rk',
    'PosRk_y': 'UnderDog Rk',
}, inplace=True)
...
merged_rbs_df['UnderDog Rk'] = merged_rbs_df['UnderDog Rk'].str.replace('RB', '')
merged_rbs_df['Sleeper Rk'] = merged_rbs_df['Sleeper Rk'].str.replace('RB', '')

merged_rbs_df['Last_Rankings'] = merged_rbs_df['Last_Rankings'].fillna(1000)
merged_rbs_df['UnderDog Rk'] = merged_rbs_df['UnderDog Rk'].fillna(1000)
merged_rbs_df['Sleeper Rk'] = merged_rbs_df['Sleeper Rk'].fillna(1000)
...
merged_rbs_df = merged_rbs_df[[ 'Name', 'Last_Rankings', 'Rk', 'UnderDog Rk', 'Sleeper Rk', 'Last_PTS/P/G', 'PTS/P/G']]